...
namespace Runner.SceneObjects.Enemies
{

    public abstract class Enemy : SpawnedObject, IMovable, IDamagable, IDamageDealer, IPeriodicDamageDealer
    {
        ...
        protected PickupDrop pickupDrop;
